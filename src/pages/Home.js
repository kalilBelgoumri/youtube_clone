...
function Home() {
  ...
  return (
    <>
      <div className="overflow-x-scroll scrollbar-hide flex justify-center items-center border-b-[1px] border-t-[1px] px-24">
        {data.map((item) => (
          <li
            key={uniqid()}
      ...
      <div className="pr-48 pl-10 gap-y-3 py-5 grid grid-cols-3 lg:grid-cols-3 xl:grid-cols-4  ">
        {posts?.map((post) => (
          <div
            key={uniqid()}
